...
public class MainData {
    ...
    private MainData() {
        ...
        group1.addExpenseToUser(user3.getName(), 14);
        group2.addExpenseToUser(user4.getName(), -4);
        group2.addExpenseToUser(user5.getName(), 40);
        group2.addExpenseToUser(user6.getName(), 24);
        group2.addExpenseToUser(user7.getName(), -94);
        group3.addExpenseToUser(user8.getName(), -74);
        group3.addExpenseToUser(user6.getName(), -54);
        group3.addExpenseToUser(user9.getName(), 61);
        group3.addExpenseToUser(user10.getName(), 42);
